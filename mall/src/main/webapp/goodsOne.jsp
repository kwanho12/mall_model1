		...
		<div class="container">
			<div class="login_form_inner register_form_inner mx-auto" style="width:500px;">
				...
				<form method="post" enctype="multipart/form-data" class="row login_form" action="<%=request.getContextPath()%>/addGoodsAction.jsp">
					...
					<div class="col-md-12 form-group">
						<button type="submit" value="submit" class="button button-register w-100 mx-auto" style="margin:30px;">수정하기</button>
						<a href="<%=request.getContextPath()%>/managerGoodsList.jsp" style="font-size:20px">이전으로</a>
					</div>
				</form>
